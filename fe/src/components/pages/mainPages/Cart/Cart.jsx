                        ...
                        <Box sx={{ display: 'flex', gap: '5px', flexDirection: 'column' }}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <Quantity
                                                    checked={selectedFoodsMemo.some(
                            ...
                            <Box sx={{ '& *': { fontWeight: 500 } }}>
                                <Typography sx={{ textAlign: 'right' }}>
                                    Đơn hàng trên{' '}
                                    <span style={{ fontWeight: 700, color: '#fe2c55' }}>{renderPrice(2000000)}</span>{' '}
                                    được miễn phí giao hàng
                                </Typography>
                                <Typography sx={{ textAlign: 'right' }}>
                                    Đơn hàng trên{' '}
                                    <span style={{ fontWeight: 700, color: '#fe2c55' }}>{renderPrice(1000000)}</span>{' '}
                                    phí giao hàng là{' '}
                                    <span style={{ fontWeight: 700, color: '#fe2c55' }}>{renderPrice(50000)}</span>
                                </Typography>
                                <Typography sx={{ textAlign: 'right' }}>
                                    Đơn hàng dưới{' '}
                                    <span style={{ fontWeight: 700, color: '#fe2c55' }}>{renderPrice(1000000)}</span>{' '}
                                    phí giao hàng là{' '}
                                    <span style={{ fontWeight: 700, color: '#fe2c55' }}>{renderPrice(100000)}</span>
                                </Typography>
                            </Box>
                        </Box>
                    </Box>
