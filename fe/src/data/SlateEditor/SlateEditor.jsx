...
import { getBlock, getMarked } from './utils/SlateUtilityFunctions.js';
    ...
    return (
        <Slate editor={editor} value={value} onChange={handleEditorChange}>
            ...
            <div className="editor-wrapper" style={{ border: '1px solid #f3f3f3', padding: '0 10px' }}>
                <Editable placeholder="Write something" renderElement={renderElement} renderLeaf={renderLeaf} />
            </div>
            {htmlAction.showInput && <CodeToText {...htmlAction} handleCodeToText={handleCodeToText} />}
        </Slate>
    );
};
