...
function PublicRoutes() {
  ...
  if (currentUser)
    return [
      ...
      { path: publicRoutes.bookings, comp: Bookings },
      { path: publicRoutes.booking, comp: Booking },
    ...
    return [
      ...
      { path: publicRoutes.bookings, comp: BackHome },
      { path: publicRoutes.booking, comp: BackHome },
