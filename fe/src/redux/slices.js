...
export const getFeedback = createAsyncThunk('getFeedback', async (feedback, thunkAPI) => {
  try {
...
export const createNewFeedback = createAsyncThunk('createNewFeedback', async (feedback, thunkAPI) => {
  try {
...
export const updateFeedback = createAsyncThunk('updateFeedback', async (updateData, thunkAPI) => {
  try {
...
export const deleteFeedback = createAsyncThunk('deleteFeedback', async (id, thunkAPI) => {
  try {
...
export const feedbackSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase('getFeedback', (state, action) => {
        return (state.feedbacks = action.payload.data);
      })
      .addCase('createNewFeedback', (state, action) => {
        return (state.feedbacks = action.payload);
      })
      .addCase('updateFeedback', (state, action) => {
        return (state.feedbacks = action.payload);
      })
      .addCase('deleteFeedback', (state, action) => {
        return (state.feedbacks = action.payload);
      });
  },
});
...
// order
export const getOrderByOrderCode = createAsyncThunk('getOrder', async (order_code, thunkAPI) => {
  try {
